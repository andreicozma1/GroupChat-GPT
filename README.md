...
- Assistant Traits, Characteristics, and Rules
    ...
    - [/src/util/assistant/AiAssistantConfigs.ts](./src/util/assistant/AssistantConfigs.ts)
    - [/src/util/prompt/AssistantPrompts.ts](./src/util/prompt/AssistantPrompts.ts)
